...
2. dump the current database in a database-neutral format: :code:`stadtctl dumpdata --natural-primary --natural-foreign --exclude sessions --exclude admin.logentry --exclude contenttypes.contenttype --exclude auth.permission >grouprise-export.json`
...
5. populate the database structure: :code:`stadtctl migrate`
6. load the export data: :code:`stadtctl loaddata --format=json - <grouprise-export.json`
