...
$(DIR_STATIC_FONT_GOOGLE): $(DIR_NODE)
	...
	touch "$(DIR_STATIC_FONT_GOOGLE)"

$(DIR_STATIC): $(DIR_STATIC_FONT_GOOGLE) $(DEPS_ASSETS) $(DEPS_WEBPACK)
	NODE_ENV=production $(RUN_NODE) $(BIN_WEBPACK) --bail
	touch "$(DIR_STATIC)"

.PHONY: assets_fonts
assets_fonts: $(DIR_STATIC_FONT_GOOGLE)
